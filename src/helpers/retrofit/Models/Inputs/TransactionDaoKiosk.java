...
public class TransactionDaoKiosk {
	...
	public class obj{
		...
		public class data{
			...
			private String gateway_integration_pk;
			private String bill_reference;
			private String agg_terminal;
			...
			public String getGateway_integration_pk() {
				return gateway_integration_pk;
			}
			public void setGateway_integration_pk(String gateway_integration_pk) {
				this.gateway_integration_pk = gateway_integration_pk;
			}
			public String getAgg_terminal() {
				return agg_terminal;
			}
			public void setAgg_terminal(String agg_terminal) {
				this.agg_terminal = agg_terminal;
			}
